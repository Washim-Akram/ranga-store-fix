// Call API (Applicarion Programming Interface)
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p class="rating-review-font">Reviews: ${product.rating.count}</p>
      <p class="rating-review-font">Ratings: ${product.rating.rate}</p>
